...
It was the worst of times.
    ...
    single_line_string = "It was the best of times,It was the worst of times."

    assert_equal 3 + single_line_string.length, long_string.length
...
single_line_string = "It was the best of times,It was the worst of times."
    ...
    assert_equal 2 + single_line_string.length, long_string.length
